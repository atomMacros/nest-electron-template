...
import { Session, Local } from '@render/utils/storage';

// 引入组件
const UserNews = defineAsyncComponent(() => import('@render/layout/navBars/breadcrumb/userNews.vue'));
const Search = defineAsyncComponent(() => import('@render/layout/navBars/breadcrumb/search.vue'));
