...
// 引入组件
const Breadcrumb = defineAsyncComponent(() => import('@render/layout/navBars/breadcrumb/breadcrumb.vue'));
const User = defineAsyncComponent(() => import('@render/layout/navBars/breadcrumb/user.vue'));
const Logo = defineAsyncComponent(() => import('@render/layout/logo/index.vue'));
const Horizontal = defineAsyncComponent(() => import('@render/layout/navMenu/horizontal.vue'));
