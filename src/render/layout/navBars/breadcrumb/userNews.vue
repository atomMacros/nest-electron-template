		...
		<div class="content-box">
			<template v-if="state.newsList.length > 0">
				<div class="content-box-item" v-for="(v, k) in state.newsList" :key="k">
					...
					<el-button @click="startUpgrade" style="float: right;" type="text" size="mini" class="content-box-btn">{{ $t('message.user.confirmUpgrade') }}</el-button>
...
import { parseTime } from "@render/utils";
