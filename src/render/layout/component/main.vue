...
// 引入组件
const LayoutParentView = defineAsyncComponent(() => import('@render/layout/routerView/parent.vue'));
const LayoutFooter = defineAsyncComponent(() => import('@render/layout/footer/index.vue'));
