...
import { reactive, onMounted, ref, watch, nextTick, onActivated, markRaw, effect, computed, toRef, toRefs } from 'vue';
...
// 	return messages.value[locale.value]['__v_raw'];
// });
...
const initPieChart = () => {
	...
	var getname = ['占比1', '占比2', '占比3', '占比4', '占比5'];
...
const initBarChart = () => {
	...
	const option = {
		...
		tooltip: { trigger: 'axis' },
		legend: { data: ['图例1', '图例2', '图例3'], right: 0 },
