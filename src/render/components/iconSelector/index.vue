...
import initIconfont from "@render/utils/getStyleSheets";
import "@render/theme/iconSelector.scss";
...
const IconList = defineAsyncComponent(
  () => import("@render/components/iconSelector/list.vue")
);
...
const initModeValueEcho = () => {
  if (props.modelValue === "")
    return ((<string | undefined>state.fontIconPlaceholder) =
      props.placeholder);
